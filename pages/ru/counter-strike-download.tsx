  ...
  return (
    <>
      ...
      <Row>
        ...
        <Col>
          <h4 className='text-2xl text-amber-300'>Minimal System req's for КС 1.6 gameplay.</h4>
      ...
      <Row>
        ...
        <Col>
          <h4 className='text-2xl text-amber-300'>Recommended System req's for КС 1.6 gameplay</h4>
